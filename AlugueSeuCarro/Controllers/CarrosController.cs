...
namespace AlugueSeuCarro.Controllers
{
    [Authorize]
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarroId,Nome,Marca,Foto,PrecoDia")] Carro carro, IFormFile arquivo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,Nome,Marca,Foto,PrecoDia")] Carro carro, IFormFile arquivo)
        {
            if (id != carro.CarroId)
            {
                _logger.LogError("Carro não encontrado");
